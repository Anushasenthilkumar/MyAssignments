...
//      20. Get the Title of Resulting Page(refer the video)  using driver.getTitle()
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Test Leaf Duplicate Lead");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Duplicate");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("Lead");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("Xyz Dup");
		driver.findElement(By.name("departmentName")).sendKeys("IT Duplicate");
		driver.findElement(By.id("createLeadForm_description")).sendKeys("Test Description Duplicate Lead");
		driver.findElement(By.id("createLeadForm_primaryEmail")).sendKeys("sampleDupMail@gmail.com");
